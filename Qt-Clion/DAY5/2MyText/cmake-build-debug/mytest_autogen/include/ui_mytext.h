...
public:
    ...
    void setupUi(QMainWindow *MyText)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/actions/document-new.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/actions/document-save.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_save->setIcon(icon3);
        action_saveas = new QAction(MyText);
        action_saveas->setObjectName(QString::fromUtf8("action_saveas"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/actions/document-save-as.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_saveas->setIcon(icon4);
        action_exit = new QAction(MyText);
        action_exit->setObjectName(QString::fromUtf8("action_exit"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/actions/exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_exit->setIcon(icon5);
        action_cut = new QAction(MyText);
        action_cut->setObjectName(QString::fromUtf8("action_cut"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/actions/edit-cut.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_cut->setIcon(icon6);
        action_copy = new QAction(MyText);
        action_copy->setObjectName(QString::fromUtf8("action_copy"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/actions/edit-copy.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_copy->setIcon(icon7);
        action_paste = new QAction(MyText);
        action_paste->setObjectName(QString::fromUtf8("action_paste"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/actions/edit-paste.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_paste->setIcon(icon8);
        action_del = new QAction(MyText);
        action_del->setObjectName(QString::fromUtf8("action_del"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/actions/edit-delete.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_del->setIcon(icon9);
        action_find = new QAction(MyText);
        action_find->setObjectName(QString::fromUtf8("action_find"));
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/actions/edit-find.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_find->setIcon(icon10);
        action_replay = new QAction(MyText);
        action_replay->setObjectName(QString::fromUtf8("action_replay"));
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/actions/edit-find-replace.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_replay->setIcon(icon11);
        action_all = new QAction(MyText);
        action_all->setObjectName(QString::fromUtf8("action_all"));
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/actions/edit-select-all.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_all->setIcon(icon12);
        ...
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/actions/edit-redo.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_redo->setIcon(icon13);
        action_color = new QAction(MyText);
        action_color->setObjectName(QString::fromUtf8("action_color"));
        centralwidget = new QWidget(MyText);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        textEdit = new QTextEdit(centralwidget);
        textEdit->setObjectName(QString::fromUtf8("textEdit"));
        textEdit->setGeometry(QRect(5, 0, 791, 421));
        QFont font;
    ...
    {
        MyText->setWindowTitle(QCoreApplication::translate("MyText", "\351\253\230\347\272\247\350\256\260\344\272\213\346\234\254", nullptr));
        ...
        action_color->setText(QCoreApplication::translate("MyText", "\351\242\234\350\211\262", nullptr));
