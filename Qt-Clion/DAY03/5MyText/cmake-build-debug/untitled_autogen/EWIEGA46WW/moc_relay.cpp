...
QT_MOC_LITERAL(1, 6, 9), // "relay_str"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 1), // "s"
QT_MOC_LITERAL(4, 19, 17), // "on_ensure_clicked"
QT_MOC_LITERAL(5, 37, 16) // "on_canel_clicked"

    },
    "Relay\0relay_str\0\0s\0on_ensure_clicked\0"
    "on_canel_clicked"
};
...
void Relay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->relay_str((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->on_ensure_clicked(); break;
        case 2: _t->on_canel_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Relay::*)(const QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Relay::relay_str)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Relay::relay_str(const QString _t1)
{
