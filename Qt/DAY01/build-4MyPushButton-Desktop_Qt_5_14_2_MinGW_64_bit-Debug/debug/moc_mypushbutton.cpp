...
#include <memory>
#include "../../4MyPushButton/mypushbutton.h"
...
QT_MOC_LITERAL(1, 13, 8), // "send_sig"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 3), // "num"
QT_MOC_LITERAL(4, 27, 11) // "btn_clicked"

    },
    "MyPushButton\0send_sig\0\0num\0btn_clicked"
};
...
void MyPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_sig((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPushButton::send_sig)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyPushButton::send_sig(int _t1)
{
